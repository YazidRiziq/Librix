...
public class EditOfficer extends javax.swing.JFrame {
    ...
    public EditOfficer(String OffID, String OffName, String OffEmail, String OffTelp) {
        initComponents();
        this.offID = OffID;
        tf_officername.setText(OffName);
        tf_officeremail.setText(OffEmail);
        tf_telpofficer.setText(OffTelp);
    }
    ...
    private void btn_submitofficerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_submitofficerActionPerformed
        try {
            Object[] params = {
                tf_officername.getText(),
                tf_officeremail.getText(),
                tf_telpofficer.getText(),              
                offID  
            };

            boolean result = oc.updateOfficer(params);
            if (result) {
